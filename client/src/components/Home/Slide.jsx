            ...
            <Deal>
                <DealText>{title}</DealText>
                {
                    timer&&<Timer>
                                ...
                                <Countdown date={Date.now() + 5.07e+7} renderer={renderer}/>
                            </Timer>
                }
                <TimerButton variant='contained' color='primary' >View All</TimerButton>
            </Deal>
            <Divider/>
            <Carousel
            responsive={responsive} swipeable={false}
            draggable={false} infinite={true} autoPlay={true} autoPlaySpeed={3000}
            keyBoardControl={true} centerMode={true}dotListClass="custom-dot-list-style"
